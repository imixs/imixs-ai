# Cassandra - The RAG Database

The retrieval database in the dynamixs.ai RAG system is based on Apache Cassandra which provides a distributed database system with high availability and scalability.
...
The RAG database stores not only the vectors but also the textual representation of the content chunks. This has several advantages:
...
Connected to dynamixsAiCluster at 127.0.0.1:9042
